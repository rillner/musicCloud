package de.illner.musiccloud.repository;

import de.illner.musiccloud.MusicCloudApp;
import de.illner.musiccloud.config.Constants;
import de.illner.musiccloud.config.audit.AuditEventConverter;
import de.illner.musiccloud.domain.PersistentAuditEvent;
...
import static de.illner.musiccloud.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
